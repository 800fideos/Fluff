...
* #72 Script de unión de personajes. (Tiene fallos)
* #137 Arreglar movimiento de todos los personajes.
* #64 Script de la habilidad especial del personaje confuso.
* #26 Ayuda en el prop Botón y muro. 

Ayuda en diversos scripts.
Revisión y arreglo de los límites (para el reinicio del nivel) de todos los niveles.
Revisión de fallos en interfaz y carga de niveles.
...
#### Miguel
* #127 Ajuste cámaras
* Búsqueda de sonidos (con Pavel).


#### Pavel
* Búsqueda de sonidos (con Miguel)
* * Las siguientes tareas se refieren a la inclusión de la canción en el editor y a la programación.
